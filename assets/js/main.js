...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.innerWidth <= 991 && !document.querySelector('.mobile-sidebar-toggle')) {
...
function createMobileSidebarToggle() {
    ...
    toggleBtn.className = 'btn btn-outline-light mobile-sidebar-toggle d-lg-none me-2';
    toggleBtn.type = 'button';
    toggleBtn.innerHTML = '<i class="bi bi-list"></i>';
    toggleBtn.style.cssText = 'z-index: 1051;';
      // Create overlay
    const overlay = document.createElement('div');
    overlay.className = 'sidebar-overlay';
    
    // Insert toggle button right after the navbar brand
    const navbarBrand = navbar.querySelector('.navbar-brand');
    if (navbarBrand && navbarBrand.nextSibling) {
        navbar.insertBefore(toggleBtn, navbarBrand.nextSibling);
    } else {
        navbar.insertBefore(toggleBtn, navbar.firstChild.nextSibling);
    }
